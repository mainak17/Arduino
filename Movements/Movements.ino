...
#define TopSpeed 90 // PWM value of ENABLE Pin For Straight Line
#define SlowSpeed 70 // PWM value of ENABLE Pin For Turns
...
if((S2==1)&&(S1==0)&&(S0==1))
 ...
 if((S2==1)&&(S1==1)&&(S0==0))
 {
  analogWrite(9,SlowSpeed);
  analogWrite(10,SlowSpeed);
 RightSpin();
 }
 if((S2==0)&&(S1==1)&&(S0==1))
 {
